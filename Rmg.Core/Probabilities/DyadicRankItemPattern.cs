...
public sealed class DyadicRankItemPattern<T>
    where T : notnull
{
    private readonly Func<IGenerationContext, Func<int, T>> _rankedItemGeneratorFunc;
    ...
    private DyadicRankItemPattern(
        ...
        Func<IGenerationContext, Func<int, T>> rankedItemGeneratorFunc,
        int generationSeed,
    ...
    )
    {
        ...
        var itemTimeline = rhythmPattern.OutcomeRankTimeline.MapValues(rankedItemGenerator);
