...
type CompositeTrackEventPattern<'T>
    ...
    new(duration: Duration,
        ...
        CompositeTrackEventPattern(
            duration,
            orderedTrackPatternTimelineMap,
            orderedTrackPatternMapTimeline,
            flatTimelineMap
        )
...
module CompositeTrackEventPattern =
    ...
    let fromInput<'T> (duration: Duration) (merge: 'T * 'T -> 'T) (input: CompositeTrackEventPatternInput<'T>) =
        CompositeTrackEventPattern<'T>(
            duration,
            input.CompositeTrackPatternTimelineMap,
            input.CompositeTrackPatternMapTimeline,
            merge
        )
