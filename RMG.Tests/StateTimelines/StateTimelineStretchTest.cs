...
public sealed class StateTimelineStretchTest
{
    ...
    [Arguments(1)]
    [Arguments(2)]
    public async Task Empty_ResultsIn_Empty(double offset)
    {
    ...
    [Test]
    public async Task ZeroFactor_ResultsIn_Empty()
    {
    ...
    [Test]
    public async Task GreaterFactor_ResultsIn_StretchedItems()
    {
        const double duration = 2;
        var items = new TimelineItem<int>[]
        {
    ...
    [Test]
    public async Task LesserFactor_ResultsIn_StretchedItems()
    {
        const double duration = 2;
        var items = new TimelineItem<int>[]
        {
