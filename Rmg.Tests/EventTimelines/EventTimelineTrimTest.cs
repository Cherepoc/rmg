...
{
    [Test]
    public async Task ZeroDurationTimeline_Trims_ToNoEvents()
    {
    ...
    [Test]
    public async Task ZeroDuration_Trim_ToZeroDuration()
    {
    ...
    [Test]
    public async Task BeforeFirstItemDuration_Trim_ToNoEvents()
    {
